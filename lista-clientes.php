    ...
    <?php
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-warning" href="index.php?menu=editar-clientes&idCliente=<?=$dados["idCliente"]?>">Editar</a></td>
                    <i class="bi bi-pencil-square"></i>

                <td>
                    <a class="btn btn-outline-danger" href="index.php?menu=excluir-clientes&idCliente=<?=$dados["idCliente"]?>">excluir</a></td>
